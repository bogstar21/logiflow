...
const TRANSLATIONS = {
  es: {
    ...
    trackPlaceholder: "Introduzca el número de seguimiento",
    ...
    alertNoCode: "Por favor, introduce el número de seguimiento",
    alertNotFound: "Número de seguimiento no encontrado.",
  ...
  ua: {
    ...
    trackPlaceholder: "Введіть номер трекінгу",
    ...
    alertNoCode: "Будь ласка, введіть номер трекінгу",
    alertNotFound: "Номер трекінгу не знайдено",
